...
- [x] 3. BaseHandlerのミドルウェア拡張
- [x] 3.1 prepare()フックによる言語検出ロジック実装
...
- [x] 11.4 BaseHandler言語検出ロジックのユニットテスト
  - URLパラメータ優先のテスト
