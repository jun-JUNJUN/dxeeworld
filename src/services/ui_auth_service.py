...
class UIAuthService:
    ...
    async def get_login_panel_state(
        ...
        try:
            ...
            access_result = await self.access_control.check_access(request_path, session_id, ip_address)
    ...
    async def get_user_menu_info(self, session_id: Optional[str]) -> Result[Dict[str, Any], UIAuthError]:
    ...
    async def check_review_access(
        ...
        try:
            access_result = await self.access_control.check_access(review_url, session_id, ip_address)
    ...
    async def check_review_submission_access(
        ...
        try:
            ...
            access_result = await self.access_control.check_access(review_submit_url, session_id, ip_address)
            ...
            if not session_id:
                ...
                session_result = await self.session_service.validate_oauth_session(session_id, ip_address)
                if not session_result.is_success:
                    reason = 'authentication_required'
                else:
    ...
    async def handle_post_auth_redirect(
        ...
        try:
            ...
            access_result = await self.access_control.check_access(original_url, session_id, ip_address)
    ...
    async def get_permission_display_info(self, user_type: str) -> Result[Dict[str, Any], UIAuthError]:
