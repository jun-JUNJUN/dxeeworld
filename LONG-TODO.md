...
[NotYet] ##Review の詳細を見る機能がない。
- Reviewの詳細ページとして、1 Companyの1人のReview投稿を、1ページで表示するページが欲しい。
- Reviewの別の詳細ページとして、1 Companyのある質問に対する複数UserのReview投稿をリスト表示するページが欲しい。

[Done]## Review投稿の確認画面が無い。
...
[Done]## Bug: Review Formで、元従業員と現従業員を選択してもサポート機能が無い。
...
[NotYet] ## 全ページの英語版・中国語・日本語版を作成したい。
